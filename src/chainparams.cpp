...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x00"); // uint256S("0x000000000000024b89b42a942fe0d9fea3bb44ab7bd1b19115dd6a759c0808b8");
        ...
        assert(consensus.hashGenesisBlock == uint256S("000003b3eb845b18a3f69e8c62dc4673dd55fc80613acc887e55238b45f2c0fe"));
        assert(genesis.hashMerkleRoot == uint256S("73075506d2c88f07780d4ffab36cfdcc7ac907844251ca2b5a04be234c7d7eb1"));
